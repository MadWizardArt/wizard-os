...
export default function PrintfulDesk() {
  ...
  return <main style={{ minHeight: "100vh", background: "#0b1118", color: "#ece7db", padding: "30px 20px 70px", fontFamily: "system-ui, sans-serif" }}>
    <div style={{ maxWidth: 980, margin: "auto", display: "grid", gap: 20 }}>
      <a href="/etsy" style={{ color: "#c9ac75", textDecoration: "none", fontSize: 13 }}>← Warlock</a>
      ...
      <section style={panel}>
        <h2 style={{ fontFamily: "Georgia, serif", marginTop: 0 }}>03 · Retail and margin</h2>
