...
export const CANONICAL_NINE_MUSES_KNOWLEDGE: Array<Omit<StoredCouncilKnowledge, "version" | "createdAt">> = [
  {
    title: "Nine Muses constitutional basis",
    content: "This document is the canonical specification for the Nine Muses Council. When the Artist invokes ‘Convene Council,’ use this canon to resolve Council identities, portfolios, governance, and operating behavior. Project-specific instructions may extend this canon but should not silently contradict it. Core principle: ‘The Muses leave their Father Apollo to enlighten the World.’",
    kind: "artist_directive",
    source: "nine_muses_project",
    sourceRef: "Nine Muses Synthesized Master · Constitutional Basis · 2026-09-16",
    category: "system",
    targetMuseIds: [],
    tags: ["constitution", "convene council", "apollo", "governance", "core principle"],
